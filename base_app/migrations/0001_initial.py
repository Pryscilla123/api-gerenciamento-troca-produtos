    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel_acesso', models.PositiveIntegerField(choices=[(None, 'Não definido'), (1, 'Usuário Repositor'), (2, 'Usuário Administrador'), (3, 'Usuário Representante de Loja')], default=1, verbose_name='nível de acesso')),
